...
\begin{luacode}
  ...
  local file = io.open("../_data/resume.json")
...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href{https://theo.lol/}{\Large Theodore Brockman}} & want to see a more interesting looking resume? \\
  Website: \href{https://theo.lol/}{theo.lol} & \href{https://theo.lol/resume}{theo.lol/resume} \\
  Email: \href{mailto:iam@theo.lol}{iam@theo.lol} \\
  LinkedIn: \href{https://linkedin.com/in/iamtheolol}{linkedin.com/in/iamtheolol} \\
  GitHub: \href{https://github.com/tbrockman}{github.com/tbrockman} \\
\end{tabular*}
