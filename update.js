...
function update_age_text(age) {
    var text = "I'm a " + age +
    "-year-old software developer who spends most of his spare time playing video games and rock climbing. \
...
function update_copyright_text() {
    var text = "copyright © " + (CURR.getYear() + 1900) + " theodore brockman";
